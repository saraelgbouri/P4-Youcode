...
using WebApiItNews.Controllers;
...
namespace WebApiItNews.Models
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        internal Task<ClaimsIdentity> GenerateUserIdentityAsync(Controllers.ApplicationUserManager userManager, string authenticationType)
        {
            throw new NotImplementedException();
        }
    }
